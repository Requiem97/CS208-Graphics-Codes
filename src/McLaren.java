...
public class McLaren extends Frame {
	...
	public void paint(Graphics g) {
		...
		winglet.lineTo(427 + x, 332 + y);
		winglet.lineTo(425 + x, 334 + y);
		winglet.moveTo(391 + x, 285 + y);
		winglet.lineTo(393 + x, 287 + y);
		winglet.lineTo(393 + x, 334 + y);
		// Shadow
		GeneralPath shadow = new GeneralPath();
		shadow.moveTo(347 + x, 285 + y);
		shadow.curveTo(367 + x, 287 + y, 378 + x, 290 + y, 385 + x, 295 + y);
		shadow.lineTo(385 + x, 334 + y);
		shadow.lineTo(393 + x, 334 + y);
		shadow.lineTo(393 + x, 287 + y);
		shadow.lineTo(391 + x, 285 + y);
		shadow.lineTo(347 + x, 285 + y);
		...
		wing.moveTo(760 + x, 337 + y);
		wing.lineTo(766 + x, 336 + y);
		wing.quadTo(770 + x, 331 + y, 766 + x, 327 + y);
		wing.lineTo(737 + x, 316 + y);
		// wing lower part
		...
		// back wing
		GeneralPath backWing = new GeneralPath();
		backWing.moveTo(640 + x, 343 + y);
		backWing.lineTo(649 + x, 343 + y);
		backWing.lineTo(680 + x, 343 + y);
		backWing.lineTo(680 + x, 288 + y);
		backWing.lineTo(667 + x, 288 + y);
		backWing.lineTo(657 + x, 283 + y);
		backWing.lineTo(640 + x, 343 + y);
		// orange body parts
		...
		GeneralPath mirror = new GeneralPath();
		mirror.moveTo(501 + x, 258 + y);
		mirror.lineTo(508 + x, 258 + y);
		mirror.quadTo(512 + x, 261 + y, 508 + x, 264 + y);
		mirror.lineTo(501 + x, 264 + y);
		mirror.lineTo(501 + x, 258 + y);
		...
		GeneralPath steer = new GeneralPath();
		steer.moveTo(494 + x, 266 + y);
		steer.lineTo(497 + x, 248 + y);
		steer.quadTo(499 + x, 246 + y, 501 + x, 248 + y);
		steer.lineTo(498 + x, 269 + y);
		steer.lineTo(494 + x, 266 + y);
		...
		Area steering = new Area(steer);
		Area behindWing = new Area(backWing);
		behindWing.subtract(fwing);
		steering.subtract(bod);
		...
		Color shadowGrey = new Color(128, 128, 128);
		Color lowerWing = new Color(74, 67, 38);
		Color windShield = new Color(79, 83, 82);
		Color wheelGrey = new Color(23, 21, 22);
		Color steerGrey = new Color(76, 76, 76);

		g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
		g2d.setColor(steerGrey);
		g2d.fill(steering);
		...
		g2d.draw(pod);
		g2d.draw(wing);
		g2d.setColor(shadowGrey);
		g2d.fill(shadow);
		g2d.setColor(lowerWing);
		g2d.draw(behindWing);
		g2d.fill(fwing);
		g2d.setColor(Color.black);
		g2d.draw(winglet);
		...
		g2d.drawString(name, 272 + x, 264 + y);
